...
PATTERN_HELPER="\[worker-node-machine\]"
WORKER_NODE_HOST_IP_PATTERN=$(grep -A1 $PATTERN_HELPER $ANSIBLE_HOSTS_FILE | tail -n 1)
sed -i "s/$WORKER_NODE_HOST_IP_PATTERN/$WORKER_NODE_HOST_IP/" $ANSIBLE_HOSTS_FILE
